    ...
    */
    public function __invoke(Request $request)
    {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        if (!$find_user_response['is_successful'] || count($find_user_response["response"]) > 0) {
        ...
        */
        if($request->has('push_token')){
            $save_push_token = $this->cacheService->saveRecord("push_tokens:{$create_user_response["response"]['id']}", ['push_token' => $request->push_token]);
        ...
        |--------------------------------------------------------------------------
        */
        $token = $this->authService->createAuthentication($create_user_response['response']);
