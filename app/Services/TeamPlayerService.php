...
class TeamPlayerService
{
	...
	*/
    ...
    {
        try {
            $query = $this->findAllInTable("team_players");
	...
	*/
    public function create(array $payload): array
    {
        ...
        */
        try {
            $query = $this->insertNewRecordInTable('team_players', $payload);
	...
	*/
    public function findWhere(array $payload): array
    {
        ...
        */
        try {
            $query = $this->findInTableWhere("team_players", $payload);
    ...
    public function update(string $selector, array $payload): array
    {
        ...
        */
        try {
            ...
            $query = $this->updateTableRecordWhereIn("team_players", $selector, $payload);
    ...
    */
    ...
    {
        try {
            $query = $this->deleteTableRecordWhereIn("team_players",$payload);
            $response = $this->bigQueryProvider->query($query)->tojson();
        } catch (Throwable $exception) {
            return [
                "status" => ServiceResponseMessageEnum::BIG_QUERY_PROVIDER_SERVICE_ERROR->value,
