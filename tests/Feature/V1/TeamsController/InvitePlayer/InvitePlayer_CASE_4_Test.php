...
/*
|--------------------------------------------------------------------------
| Test Case 2 -> check if auth user is trying to invite self
|--------------------------------------------------------------------------
*/
class InvitePlayer_CASE_4_Test extends TestCase
{
    public function test_case()
    {
        ...
        */
        ...
        ->assertJson([
            'status' => 400,
            'message' => ResponseCodeEnums::USER_CANT_INVITE_SELF_ERROR->name,
            'response_code' => ResponseCodeEnums::USER_CANT_INVITE_SELF_ERROR->value,
        ]);
    }
}
